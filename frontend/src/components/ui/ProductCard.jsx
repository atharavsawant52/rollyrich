    ...
    <Link to={`/product/${product.id}`}>
      ...
      >
        ...
        <div className="overflow-hidden">
          <motion.img
            src={product.media?.[1] || product.image || "/default.jpg"}
            alt={product.title || product.name}
            className="w-full h-64 object-cover object-top rounded-t-xl transition-transform duration-500 group-hover:scale-105"
            loading="lazy"
          />
        </div>
